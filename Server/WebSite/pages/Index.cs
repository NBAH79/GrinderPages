...
public void Instance(IManager manager, out Page t)
{
    ...
    Block BlockWithText=new Block(manager,"","",new List<Component>());
    Text ResultText=new Text(manager,"t14 cg87", "", "");

    var body = new List<Component>(){
        new Frame(manager, "_white", "margin:24px;padding:12px;height:100%;width:auto",new List<Component>() {

            {BlockWithText=new Block(manager,"col", "margin:auto", new List<Component>() {
    ...
    var ret = new IndexPage(body);
    ret.BlockWithText=BlockWithText;
    ret.ResultText=ResultText;
    t=ret;
}
